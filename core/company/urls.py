...
position_router.register(
    r'positions', PositionAPIViewSet, basename='company-position')

project_router = NestedSimpleRouter(router, r'companies', lookup='company')
project_router.register(r'projects', ProjectAPIViewSet,
                        basename='company-project')

department_router = NestedSimpleRouter(router, r'companies', lookup='company')
department_router.register(
    r'departments', DepartmentAPIViewSet, basename='company-department')
